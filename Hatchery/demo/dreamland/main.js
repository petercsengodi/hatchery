...
const numberOfScenesDragon = 0;
const animationDragon = [
]; // end of animationDragon
const geometryPart0 = new THREE.BufferGeometry();

const verticesPart0 = new Float32Array([
	-80.0, 0.0,  100.0,
	80.0, 0.0,  100.0,
	0.0, 100.0,  -100.0,
	-80.0, 0.0,  100.0,
...
geometryPart0.setIndex(indicesPart0);
geometryPart0.setAttribute('position', new THREE.BufferAttribute(verticesPart0, 3));
const materialPart0 = new THREE.MeshBasicMaterial({color: 0xff0000});
const meshPart0 = new THREE.Mesh(geometryPart0, materialPart0);
meshPart0.matrixAutoUpdate = false;
