...
public class AnimatorMeshXYSideView extends AnimatorMeshSideView implements ComponentMeshXYSideView {

	public AnimatorMeshXYSideView(GameEngineFacade facade, AnimatorViewCanvas canvas) {
		super(facade, canvas);
