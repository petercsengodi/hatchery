...
public class StartP32x32Editor {
	...
	public static final String GENERATED_FILE = "generated32x32.js";
	public static final int MAXIMUM_NUMBER_OF_SHEETS = 100;

	public static void main(String[] args) {
		P32x32Editor editor = new P32x32Editor(PIX_FILE, GENERATED_FILE, MAXIMUM_NUMBER_OF_SHEETS, 32, 32);
		editor.startEditor();
	}
