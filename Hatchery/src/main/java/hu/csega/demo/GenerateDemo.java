...
public class GenerateDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File mainJS = new File(resourceAdapter.projectRoot() + "demo" + File.separator + "main.js");
        ...
        File head = new File(resourceAdapter.projectRoot() + "src" + File.separator + "main" + File.separator + "java" +
                File.separator + "hu" + File.separator + "csega" + File.separator + "demo" + File.separator + "main.js.head.txt");
        File tail = new File(resourceAdapter.projectRoot() + "src" + File.separator + "main" + File.separator + "java" +
                File.separator + "hu" + File.separator + "csega" + File.separator + "demo" + File.separator + "main.js.tail.txt");
