...
public class SuperstitionGameSpellsBuilder implements GameEngineCallback {
	...
	public Object call(GameEngineFacade facade) {
		...
		GameObjectHandler texture = store.loadTexture("texture.png");
		...
		SuperstitionGameSpellsModel mainMenu = (SuperstitionGameSpellsModel) model.getMainMenu().getModel();
